...
class ProgressInBookOld extends StatefulWidget {
  const ProgressInBookOld({Key? key, required this.bookName, required this.bookNumber}) : super(key: key);
  final String bookName;
  final int bookNumber;

  @override
  State<ProgressInBookOld> createState() => _ProgressInBookOldState();
}

class _ProgressInBookOldState extends State<ProgressInBookOld> {
      ...
      child: Scaffold(
        ...
        body: Column(
          children: [
            ...
            MyChoiceChips(count: booksTomes[widget.bookNumber], color: Colors.cyan,),
            Expanded(
              child: Padding(
